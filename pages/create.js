...
export default function CreateUser() {
	const [imgBorder, setImgBorder] = useState('119,30,135,1');
			...
			<div className='create-user'>
				...
				<div className='create-user__form'>
					<img
						...
						style={{
							border: `3px solid rgb(${imgBorder})`,
						}}
					/>
					<div className='create-user__input-group'>
						...
						<div className='create-user__colors'>
							<div
								...
								onClick={() => setImgBorder('119,30,135,1')}
							/>
							<div
								...
								onClick={() => setImgBorder('238,255,18,1')}
							/>
							<div
								className='create-user__color '
								style={{
								...
								onClick={() => setImgBorder('135,30,66,1')}
							/>
							<div
								className='create-user__color '
								style={{
								...
								onClick={() => setImgBorder('18,51,255,1')}
							/>
							<div
								className='create-user__color '
								style={{
								...
								onClick={() => setImgBorder('30,129,135,1')}
							/>
						</div>
					</div>
				</div>
